...
import { RiEBikeFill, RiUserCommunityFill } from "react-icons/ri";
            ...
            <ul className="space-y-4">
                ...
                {role === "admin" && (    //"admin"
                    <>
                        ...
                        <li>
                            <Link className="flex items-center gap-3" to="/dashboard/assign-decorators">
                                <RiEBikeFill />
                                {isOpen && "Assign Decorators"}
                            </Link>
                        </li>
                        <li>
